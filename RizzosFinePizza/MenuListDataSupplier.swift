...
var classicPies : [(String,String,Double)] {
get {
    return [PersonalRound,LargeRound,LargeSquare]
...
var cyo : [(String,String,Double)] {
get {
    return [CYOPersonalRound,CYOLargeRound,CYOLargeSquare]
...
var Americana : [(String,String,Double)] {
get {
    return [AmericanaPersonalRound,AmericanaLargeRound,AmericanaLargeSquare]
...
var AummaAumma : [(String,String,Double)] {
get {
    return [AummaAummaPersonalRound,AummaAummaLargeRound,AummaAummaLargeSquare]
...
var Bandiera : [(String,String,Double)] {
get {
    return [BandieraPersonalRound,BandieraLargeRound,BandieraLargeSquare]
...
var Cafona : [(String,String,Double)] {
get {
    return [CafonaPersonalRound,CafonaLargeRound,CafonaLargeSquare]
...
var Capponata : [(String,String,Double)] {
get {
    return [CapponataPersonalRound,CapponataLargeRound,CafonaLargeSquare]
...
var Carnosa : [(String,String,Double)] {
get {
    return [CarnosaPersonalRound,CapponataLargeRound,CarnosaLargeSquare]
...
var Contadina : [(String,String,Double)] {
get {
    return [ContadinaPersonalRound,ContadinaLargeRound,ContadinaLargeSquare]
...
var Cortese : [(String,String,Double)] {
get {
    return [CortesePersonalRound,CorteseLargeRound,CorteseLargeSquare]
...
var Diavola : [(String,String,Double)] {
get {
    return [DiavolaPersonalRound,DiavolaLargeRound,DiavolaLargeSquare]
...
var Ditta : [(String,String,Double)] {
get {
    return [DittaPersonalRound,DittaLargeRound,DittaLargeSquare]
...
var Fantasia : [(String,String,Double)] {
get {
    return [FantasiaPersonalRound,FantasiaLargeRound,FantasiaLargeSquare]
...
var Forzuta : [(String,String,Double)] {
get {
    return [ForzutaPersonalRound,ForzutaLargeRound,ForzutaLargeSquare]
...
var Francesco : [(String,String,Double)] {
get {
    return [FrancescoPersonalRound,LargeRound,LargeSquare]
...
var Giardino : [(String,String,Double)] {
get {
    return [GiardinoPersonalRound,GiardinoLargeRound,GiardinoLargeSquare]
...
var Golosa : [(String,String,Double)] {
get {
    return [GolosaPersonalRound,GolosaLargeRound,GolosaLargeSquare]
...
var Greca : [(String,String,Double)] {
get {
    return [GrecaPersonalRound,GrecaLargeRound,GrecaLargeSquare]
...
var Gustosa : [(String,String,Double)] {
get {
    return [GustosaPersonalRound,GustosaLargeRound,GustosaLargeSquare]
...
var Mafiosa : [(String,String,Double)] {
get {
    return [MafiosaPersonalRound,MafiosaLargeRound,MafiosaLargeSquare]
...
var Margherita : [(String,String,Double)] {
get {
    return [MargheritaPersonalRound,MargheritaLargeRound,MargheritaLargeSquare]
...
var Marinara : [(String,String,Double)] {
get {
    return [MarinaraPersonalRound,MarinaraLargeRound,MargheritaLargeSquare]
...
var Nessa : [(String,String,Double)] {
get {
    return [NessaPersonalRound,NessaLargeRound,NessaLargeSquare]
...
var Parmigiana : [(String,String,Double)] {
get {
    return [ParmigianaPersonalRound,ParmigianaLargeRound,ParmigianaLargeSquare]
...
var Primavera : [(String,String,Double)] {
get {
    return [PrimaveraPersonalRound,PrimaveraLargeRound,PrimaveraLargeSquare]
...
var Puttanesca : [(String,String,Double)] {
get {
    return [PuttanescaPersonalRound,PuttanescaLargeRound,PuttanescaLargeSquare]
...
var QuattroFormaggi : [(String,String,Double)] {
get {
    return [QuattroFormaggiPersonalRound,QuattroFormaggiLargeRound,QuattroFormaggiLargeSquare]
...
var Rustica : [(String,String,Double)] {
get {
    return [RusticaPersonalRound,RusticaLargeRound,RusticaLargeSquare]
...
var SottoSopra : [(String,String,Double)] {
get {
    return [SottoSopraPersonalRound,SottoSopraLargeRound,SottoSopraLargeSquare]
...
var Spagnola : [(String,String,Double)] {
get {
    return [SpagnolaPersonalRound,SpagnolaLargeRound,SpagnolaLargeSquare]
...
var Verdura : [(String,String,Double)] {
get {
    return [VerduraPersonalRound,VerduraLargeRound,VerduraLargeSquare]
...
var speciality :[[(String,String,Double)]] {
get {
    
    return [Americana,AummaAumma,Bandiera,Cafona,Capponata,Carnosa,Contadina,Cortese,Diavola,Ditta,Fantasia,Forzuta,Francesco,Giardino,Golosa,Greca,Gustosa,Mafiosa,Margherita,Marinara,Nessa,Parmigiana,Primavera,Puttanesca,QuattroFormaggi,Rustica,SottoSopra,Spagnola,Verdura]
}
 ...
 */
    ...
    func tableView(tableView: UITableView,
        ...
        guard let section = numberOfSectionsInTableView(indexPath.section) else {
            fatalError()
        }
        ...
        switch section {
        case 0:
            item = itemManager.checkItemAtIndex(indexPath.row)
               }
