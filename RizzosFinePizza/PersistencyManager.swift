 ...
 */
        americana = FoodItem(title:"Americana*",itemDescription:"Mozzarella, Grated Cheese and Sauce. Add toppings to your pie for $2.00 each.",originalPrice :[15.00,23.00,23.00])
        ...
        */
        aummaAumma = FoodItem(title:"Aumma Aumma",itemDescription:"Sausage, meatball, ricotta, sauce, mozzarella",originalPrice :[15.00,23.00,23.00])
 ...
 */
        ...
        bandiera = FoodItem(title:"Bandiera ",itemDescription:"Spinach, fresh garlic, ricotta, sauce, mozzarella",originalPrice :[15.00,23.00,23.00])
        /*
 ...
 */
        cafona = FoodItem(title:"Cafona ",itemDescription:"Ricotta, pepperoni, sauce, mozzarella",originalPrice :[15.00,23.00,23.00])
 ...
 */
        capponata = FoodItem(title:"Capponata",itemDescription:"Eggplant, red onion, black & green olive, caper, sauce, mozzarella",originalPrice :[15.00,23.00,23.00])
 ...
 */
        carnosa = FoodItem(title:"Carnosa",itemDescription:"Meatball, bacon, pepperoni, grilled chicken, sausage, sauce, mozzarella.",originalPrice :[15.00,23.00,23.00])
 ...
 */
        contadina = FoodItem(title:"Contadina Personal Round",itemDescription:"Grilled chicken, plum tomato, bacon, red onion, sauce, mozzarella.",originalPrice :[15.00,23.00,23.00])
 ...
 */
        cortese = FoodItem(title:"Cortese*",itemDescription:"Ricotta, plum tomato, basil pesto, mozzarella. Not made with tomato sauce, unless requested.",originalPrice :[15.00,23.00,23.00])
 ...
 */
        diavola = FoodItem(title:"Diavola*",itemDescription:"Grilled chicken, red onion, bacon, award-winning BBQ sauce, hot sauce, parmigiano aioli, mozzarella.",originalPrice :[15.00,23.00,23.00])
 ...
 */
        ...
        ditta = FoodItem(title:"Ditta Personal Round",itemDescription:"Sausage, mushroom, pepperoni, pesto, bacon, sauce, mozzarella.",originalPrice :[15.00,23.00,23.00])
 ...
 */
        fantasia = FoodItem(title:"Fantasia*",itemDescription:"Basil pesto, ricotta, roasted pepper, black olive, marinated mushroom, mozzarella. Not made with tomato sauce, unless requested..",originalPrice :[15.00,23.00,23.00])
 ...
 */
        forzuta = FoodItem(title:"Forzuta",itemDescription:"Sausage, bell pepper, red onion, sauce, mozzarella.",originalPrice :[15.00,23.00,23.00])
        /*
 ...
 */
        francesco = FoodItem(title:"Francesco*",itemDescription:"Grilled chicken, plum tomato, black olive, basil pesto, mozzarella. Not made with tomato sauce, unless requested.",originalPrice :[15.00,23.00,23.00])
 ...
 */
        giardino = FoodItem(title:"Giardino",itemDescription:"Bell pepper, marinated mushroom, red onion, fresh garlic, plum tomato, black olive, sauce, mozzarella.",originalPrice :[15.00,23.00,23.00])
 ...
 */
        golosa = FoodItem(title:"Golosa* Personal Round",itemDescription:"Grilled chicken, marinated mushroom, spinach, bacon, red onion, mozzarella. Not made with tomato sauce, unless requested.",originalPrice :[15.00,23.00,23.00])
 ...
 */
        greca = FoodItem(title:"Greca*",itemDescription:"Spinach, ricotta, fresh garlic, red onion, mozzarella.  Not made with tomato sauce, unless requested.",originalPrice :[15.00,23.00,23.00])
 ...
 */
        gustosa = FoodItem(title:"Gustosa",itemDescription:"Eggplant, roasted pepper, basil pesto, sauce, fresh mozzarella.",originalPrice :[15.00,23.00,23.00])
 ...
 */
        mafiosa = FoodItem(title:"Mafiosa Personal Round",itemDescription:"Sausage, roasted pepper, black & green olive, caper, sauce, mozzarella.",originalPrice :[15.00,23.00,23.00])
 ...
 */
        margherita = FoodItem(title:"Margherita",itemDescription:"Plum tomato, red onion, sauce, fresh basil & mozzarella.",originalPrice :[15.00,23.00,23.00])
 ...
 */
        marinara = FoodItem(title:"Marinara",itemDescription:"Toasted anchovy, fresh garlic, caper, oregano, sauce, fresh mozzarella.",originalPrice :[15.00,23.00,23.00])
 ...
 */
        nessa = FoodItem(title:"Nessa Personal Round",itemDescription:"Bacon, red onions, fresh basil, sauce, mozzarella, parmigiano aioli.",originalPrice :[15.00,23.00,23.00])
 ...
 */
        parmigiana = FoodItem(title:"Parmigiana",itemDescription:"Eggplant, fresh basil, garlic & mozzarella, ricotta.",originalPrice :[15.00,23.00,23.00])
 ...
 */
        primavera = FoodItem(title:"Primavera",itemDescription:"Spinach, fresh garlic, roasted pepper, red onion, black olive, sauce, fresh mozzarella.",originalPrice :[15.00,23.00,23.00])
 ...
 */
        puttanesca = FoodItem(title:"Puttanesca",itemDescription:"Marinated mushroom, roasted pepper, red onion, black & green olive, caper, sauce, mozzarella.",originalPrice :[15.00,23.00,23.00])
 ...
 */
        quattroFormaggi = FoodItem(title:"Quattro Formaggi*",itemDescription:"Ricotta, mozzarella, romano, fresh garlic, herbs, parmigiano aioli. Not made with tomato sauce, unless requested.",originalPrice :[15.00,23.00,23.00])
 ...
 */
        rustica = FoodItem(title:"Rustica",itemDescription:"Toasted anchovy, black olive, fresh garlic, caper, red onion, sauce, mozzarella.",originalPrice :[15.00,23.00,23.00])
 ...
 */
        sottoSopra = FoodItem(title:"Sotto Sopra",itemDescription:"Fresh garlic, ricotta, oregano, sauce, mozzarella.",originalPrice :[15.00,23.00,23.00])
 ...
 */
        spagnola = FoodItem(title:"Spagnola",itemDescription:"Pepperoni, green olive, red onion, roasted pepper, sauce, mozzarella.",originalPrice :[15.00,23.00,23.00])
 ...
 */
       verdura = FoodItem(title:"Verdura* Personal Round",itemDescription:"Pepperoni, green olive, red onion, roasted pepper, sauce, mozzarella.",originalPrice :[15.00,23.00,23.00])
